...
export interface MonacoQueryInputProps extends ThemeProps, SettingsCascadeProps {
...
export const MonacoQueryInput: React.FunctionComponent<MonacoQueryInputProps> = ({
    ...
    const options: Monaco.editor.IStandaloneEditorConstructionOptions = {
        ...
        // TODO(tj): use editor font from props (for vsce)
    ...
    return (
        <div ref={setContainer} className={className} onFocus={onFocus}>
            <MonacoEditor
